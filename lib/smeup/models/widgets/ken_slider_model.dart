...
class KenSliderModel extends KenModel {
  ...
  KenSliderModel.fromMap(
    ...
    sldMin =
        KenUtilities.getDouble(optionsDefault!['sldMin']) ?? defaultSldMin;
    sldMax =
        KenUtilities.getDouble(optionsDefault!['sldMax']) ?? defaultSldMax;
    padding =
  ...
  static setDefaults(dynamic obj) {
    SliderThemeData sliderThemeData =
        KenThemeConfigurationService.getTheme()!.sliderTheme;
