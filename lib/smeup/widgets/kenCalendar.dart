...
class KenCalendar extends StatefulWidget
  ...
  KenCalendar(
    ...
    this.id = '',
    this.type = 'CAL',
    this.eventFontSize = KenCalendarModel.defaultEventFontSize,
    this.titleFontSize = KenCalendarModel.defaultTitleFontSize,
    this.dayFontSize = KenCalendarModel.defaultDayFontSize,
    this.markerFontSize = KenCalendarModel.defaultMarkerFontSize,
    this.data,
...
class KenCalendarState extends State<KenCalendar>
  ...
  set startFunDate(DateTime startFunDate) {
    ...
    KenMessageBus.instance.publishRequest(
      ...
      KenTopic.kenCalendarStartFunDate,
      KenMessageBusEventData(
          context: context, widget: widget, model: _model, data: _startFunDate),
    );
  }
  ...
  set endFunDate(DateTime endFunDate) {
    ...
    KenMessageBus.instance.publishRequest(
      widget.globallyUniqueId,
      KenTopic.kenCalendarEndFunDate,
      KenMessageBusEventData(
          context: context, widget: widget, model: _model, data: _endFunDate),
    );
  }
  ...
  Future<dynamic> _clientOnChangeMonth(DateTime focusedDay) async {
    ...
    if (widget.model != null) {
      KenMessageBus.instance.publishRequest(
        widget.globallyUniqueId,
        KenTopic.kenCalendarClientOnChangeMonth,
        KenMessageBusEventData(
