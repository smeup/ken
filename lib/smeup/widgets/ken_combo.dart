...
import 'package:ken/smeup/widgets/ken_combo_widget.dart';
...
class _KenComboState extends State<KenCombo>
  ...
  Future<KenWidgetBuilderResponse> getChildren() async {
    ...
    if (widget.callBack!= null) {
      widget.callBack!(widget, KenCallbackType.getChildren, _selectedValue,null);
    }
      ...
      child: Container(
          ...
          child: KenComboWidget(
            ...
            clientOnChange: (String? newValue) {
              ...
              if (widget.callBack!= null) {
                widget.callBack!(widget, KenCallbackType.onClientChange, _selectedValue,null);
              }
