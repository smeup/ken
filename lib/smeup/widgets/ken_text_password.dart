...
import 'package:ken/smeup/widgets/ken_text_password_indicators.dart';
...
class KenTextPassword extends StatefulWidget with KenWidgetMixin implements KenWidgetInterface {
...
class _KenTextPasswordState extends State<KenTextPassword>
  ...
  Future<KenWidgetBuilderResponse> getChildren() async {
    ...
    final passwordFieldModel = Provider.of<KenTextPasswordVisibilityNotifier>(
        context,
        listen: false);
