...
class _KenRadioButtonsState extends State<KenRadioButtons>
  ...
  Future<KenWidgetBuilderResponse> getChildren() async {
    ...
    if (_model != null && _model!.parent != null) {
      ...
      if (radioWidth == 0)
        radioWidth = KenUtilities.getDeviceInfo().safeWidth;
    }
    ...
    _data.forEach((radioButtonData) {
      ...
      final button = KenRadioButton(
          id:
              '${KenUtilities.getWidgetId(widget.type, widget.id)}_${buttonIndex.toString()}',
          type: widget.type,
          title: widget.title,
          ...
          onPressed: (value) {
            ...
            if (widget.callBack != null) {
              widget.callBack!(widget,KenCallbackType.onPressed, value,_data,);
            }
          });
