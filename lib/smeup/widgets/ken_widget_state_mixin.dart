  ...
  Future<KenWidgetBuilderResponse> getFunErrorResponse(
    ...
    return Future(() {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content:Text('${KenLocalizationService.of(context)!.getLocalString('dataNotAvailable')}.  (${model == null ? '' : model.smeupFun!.identifier.function})'),
          backgroundColor: KenThemeConfigurationService.getTheme()!.errorColor,
        ),
      );
