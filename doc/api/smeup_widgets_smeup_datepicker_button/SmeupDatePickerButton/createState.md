...
_SmeupDatePickerButtonState createState
()
...
later inserted into the tree again, the framework will call <a href="../../smeup_widgets_smeup_datepicker_button/SmeupDatePickerButton/createState.md">createState</a>
