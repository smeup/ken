...
_SmeupProgressBarState createState
()
...
later inserted into the tree again, the framework will call <a href="../../smeup_widgets_smeup_progress_bar/SmeupProgressBar/createState.md">createState</a>
