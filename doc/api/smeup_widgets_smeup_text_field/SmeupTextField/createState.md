...
_SmeupTextFieldState createState
()
...
later inserted into the tree again, the framework will call <a href="../../smeup_widgets_smeup_text_field/SmeupTextField/createState.md">createState</a>
