...
_SmeupCalendarWidgetState createState
()
...
later inserted into the tree again, the framework will call <a href="../../smeup_widgets_smeup_calendar_widget/SmeupCalendarWidget/createState.md">createState</a>
