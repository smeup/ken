...
_SmeupQRCodeReaderState createState
()
...
later inserted into the tree again, the framework will call <a href="../../smeup_widgets_smeup_qrcode_reader/SmeupQRCodeReader/createState.md">createState</a>
