...
_SmeupDatePickerState createState
()
...
later inserted into the tree again, the framework will call <a href="../../smeup_widgets_smeup_datepicker/SmeupDatePicker/createState.md">createState</a>
