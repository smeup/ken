...
_SmeupInputPanelState createState
()
...
later inserted into the tree again, the framework will call <a href="../../smeup_widgets_smeup_inputpanel/SmeupInputPanel/createState.md">createState</a>
